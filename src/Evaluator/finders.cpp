...
namespace clnt::eval::finders {
    ...
    findBrackets(Slice<vector<unique_ptr<Lexeme>>> const& lexemes, vector<char> const& bracketSet) {
    ...
    pair<unique_ptr<Token>, size_t> findBlock(Slice<vector<unique_ptr<Lexeme>>> const& lexemes, unique_ptr<Token> const&) {
    ...
    pair<unique_ptr<Token>, size_t> findCallOperator(Slice<vector<unique_ptr<Lexeme>>> const& lexemes, unique_ptr<Token> const&) {
        auto brackets = findBrackets(lexemes, {'(', ')'});
        if (brackets) {
    ...
    pair<unique_ptr<Token>, size_t> findOperator(Slice<vector<unique_ptr<Lexeme>>> const& lexemes, unique_ptr<Token> const& lastToken) {
    ...
    pair<unique_ptr<Token>, size_t> findReserved(Slice<vector<unique_ptr<Lexeme>>> const& lexemes, unique_ptr<Token> const& lastToken) {
    ...
    pair<unique_ptr<Token>, size_t> findSemicolon(Slice<vector<unique_ptr<Lexeme>>> const& lexemes, unique_ptr<Token> const& lastToken) {
    ...
    pair<unique_ptr<Token>, size_t> findWord(Slice<vector<unique_ptr<Lexeme>>> const& lexemes, unique_ptr<Token> const& lastToken) {
        using namespace clnt::alphabet;
    ...
    pair<unique_ptr<Token>, size_t> findLineBreak(Slice<vector<unique_ptr<Lexeme>>> const& lexemes, unique_ptr<Token> const& lastToken) {
    ...
    pair<unique_ptr<Token>, size_t> findComma(Slice<vector<unique_ptr<Lexeme>>> const& lexemes, unique_ptr<Token> const& lastToken) {
    ...
    pair<unique_ptr<Token>, size_t> findSharp(Slice<vector<unique_ptr<Lexeme>>> const& lexemes, unique_ptr<Token> const& lastToken) {
    ...
    pair<unique_ptr<Token>, size_t> findBackslash(Slice<vector<unique_ptr<Lexeme>>> const& lexemes, unique_ptr<Token> const& lastToken) {
    ...
    pair<unique_ptr<Token>, size_t> findColon(Slice<vector<unique_ptr<Lexeme>>> const& lexemes, unique_ptr<Token> const& lastToken) {
    ...
    pair<unique_ptr<Token>, size_t> findQuestion(Slice<vector<unique_ptr<Lexeme>>> const& lexemes, unique_ptr<Token> const& lastToken) {
    ...
    std::pair<unique_ptr<Token>, size_t> findInit(Slice<std::vector<std::unique_ptr<lex::Lexeme>>> const& lexemes, unique_ptr<Token> const& lastToken) {
